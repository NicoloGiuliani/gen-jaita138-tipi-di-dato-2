...
public class AppCliente
{
    public static void main(String[] args) throws Exception 
    {
        ...
        //Serve per interpretare correttamente la stringa dell'utente e convertirla in un oggetto LocalDate.
        LocalDate dataNascita = LocalDate.parse(dataNascitaStr, formatter);
        //Converte la stringa della data (dataNascitaStr) in un oggetto LocalDate usando il formatter creato in precedenza.
